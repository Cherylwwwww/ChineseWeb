  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-50 to-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Interactive Chinese Learning</h1>
        <p className="text-xl text-gray-600 mb-12">
          Explore the fascinating aspects of Chinese language through our interactive learning tools.
          Master tones, practice pronunciation, and learn characters through engaging exercises.
        </p>
